...
include('include/header.php');
	...
	//get the all my teachers,and count them 
	$sql = ("SELECT * FROM users WHERE `role`= 2 ");
	$teachers = mysqli_query($conn, $sql);

	//get the all my admins,and count them 
	 ...
	 <div class="market-updates">
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-8 market-update-left">
						<h3><?php echo mysqli_num_rows($admins)?></h3>
						<h4>Admin</h4>
						<p>No of Admins</p>
					</div>
			...
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-2">
				 <div class="col-md-8 market-update-left">
					<h3><?php echo mysqli_num_rows($teachers)?></h3>
					<h4>Teachers</h4>
					<p>Total Numbers of Teachers</p>
				  </div>
					<div class="col-md-4 market-update-right">
		...
		<div class="col-md-8 col-md-offset-2 chart-layer1-right"> 
			...
			<div class="malorm-bottom">
				<span class="malorum-pro"> 
			     ...
			     <h4>Welcome!</h4>
				 <h2><?php echo $admin_row['last_name'] .' '. $admin_row['first_name'];?></h2>
