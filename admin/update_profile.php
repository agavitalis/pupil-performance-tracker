...
<div class="inner-block">
   <div class="bread-crom">
		<p>
		  <i class="fa fa-user"></i>	Admin/Update Profile
		</p>
                ...
                <div class="col-md-9">
                  <form class="form-horizontal" role="form" method="POST" action="" >
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input  name="f_name" required="" type="name" class="form-control" id="" placeholder="Enter your name" value="<?php echo $admin_row['first_name']; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="">Last Name</label>
                      <div class="col-sm-9">
                        <input  name="l_name" required="" type="name" class="form-control" id="" placeholder="Enter your name" value="<?php echo $admin_row['last_name']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input  name="phone" required=""type="name" class="form-control" id="" placeholder="Enter your Phone Number" value="<?php echo $admin_row['phone']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input name="email" required="" type="email" class="form-control" id="" placeholder="Enter your email" value="<?php echo $admin_row['email']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input  name="address" required=""type="name" class="form-control" id="" placeholder="Enter your address" value="<?php echo $admin_row['address']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">          
                        <input  name="password" required="" type="password" class="form-control" id="" placeholder="Enter your password" >
                      </div>
                    </div>
