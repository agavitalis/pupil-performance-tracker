...
<div class="inner-block">
	<div class="bread-crom">
		<p>
		<i class="fa fa-home"></i>	Teacher/Profile
		</p>
   					...
   					<div class="panel-body admin-panel-body text-center">
    					<div class="col-md-3 profile-pix">
							<img src="uploads/<?php echo $teacher_row['picture']; ?>" class="img-circle " width="140px" height="140px">
							 <p> Welcome <?php echo $teacher_row['first_name'];?></p>
						...
						<div class="col-md-9 ">
							<table class="table table-bordered table-striped">
								<tbody>
									...
									<tr>
										<td>Username</td>
										<td id="address"><?php echo $teacher_row['username']; ?></td>
									</tr>
									<tr>
										<td>Email</td>
										<td id="email"><?php echo $teacher_row['email']; ?></td>
									</tr>
									<tr>
										<td>Phone Number</td>
										<td id="phone"><?php echo $teacher_row['phone']; ?></td>
									</tr>
									<tr>
										<td>Gender</td>
										<td id="gender"><?php echo $teacher_row['gender']; ?> </td>
									</tr>
									<tr>
										<td>Address</td>
										<td id="address"><?php echo $teacher_row['address']; ?></td>
									</tr>
                        				
                      				
									<tr>
										<td>Role:</td>
										<td id="username">Teacher </td>
									</tr> 
									<tr>
										<td>Class:</td>
										<td id="klass"><?php echo $teacher_row['class']; ?> </td>
									</tr>        	
								</tbody>	
							</table>
							<div>
								
								<button class="btn btn-flat btn-success pull-right"> <a href="update_teacher.php"><i class="fa fa-ok"></i>Update Profile</a></button>
